...
class AboutDictionaries(Koan):
    ...
    def test_dictionary_literals(self):
        ...
        # The length is based on the  number of keys.
        self.assertEqual(2, len(babel_fish))

    def test_accessing_dictionaries(self):
        babel_fish = { 'one': 'uno', 'two': 'dos' }
        # These are the values of what the keys are looking for.
    ...
    def test_making_a_dictionary_from_a_sequence_of_keys(self):
        ...
        # The length is based on this first set of arguments.
        #  The values are all 42.
