...
class AboutMethods(Koan):
    ...
    def test_calling_functions_with_wrong_number_of_arguments(self):
        ...
        # This is part of the error message when you provide more arguments.
        self.assertRegex(msg, "3 were given")
    ...
    def test_which_does_not_return_anything(self):
        # No return value. The default return value is None.
    ...
    def test_calling_with_default_values(self):
        # If no argument given default_value is the result for b.
    ...
    def test_calling_with_variable_arguments(self):
        # Not providing an argument provides an empty tuple.
        self.assertEqual((), self.method_with_var_args())
        # Providing one argument, gives a tuple with one item.
        self.assertEqual(('one',), self.method_with_var_args('one'))
        # Providing more gives you more items in a tuple.
    ...
    def test_functions_without_self_arg_are_global_functions(self):
        def function_with_the_same_name(a, b):
            return a * b
        # 12 is the answer because the second one overwrites the first.
    ...
    def test_calling_methods_in_same_class_with_explicit_receiver(self):
        ...
        # Seven is the result because things were done to ensure it wasn't overwritten.
    ...
    # Scope is probably the answer why 10 is the result called here.
    ...
    # Python is fine with one line methods.
    ...
    def method_with_documentation(self):
        ...
        return "ok"
    # This was looking for part of the docstring.
    def test_the_documentation_can_be_viewed_with_the_doc_method(self):
        self.assertRegex(self.method_with_documentation.__doc__, "A string")
    ...
    def test_attributes_with_double_underscore_prefixes_are_subject_to_name_mangling(self):
        rover = self.Dog()
        # __ items in a class are difficult to access on the outside.
        with self.assertRaises(AttributeError): password = rover.__password()
        # I think this is how you access a "private" variable in Python.
        # But this still is!
